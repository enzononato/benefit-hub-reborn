...
BEGIN
  ...
  -- Idempotência: se já existe chamado para esta conversation_id, retorna o protocolo existente
  -- (protege contra retries automáticos do n8n após instabilidade da API de IA)
  ...
  -- Block if collaborator already has an open request (aberta or em_analise)
